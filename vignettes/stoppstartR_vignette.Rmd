...
```{r setup, eval=FALSE}
# Install the remotes package & use its function, install_github, to install the stoppstartR package.
install.packages("remotes")
remotes::install_github("https://github.com/IarlaithDoherty/stoppstartR")

# Given patient data in the form of a data.frame called patient_data_frame, apply all of the
# implemented STOPP/START criteria using the all_stoppstart function from stoppstartR.
